...
import { type CertInfo } from "@/utils/DataCollector";
  ...
  return (
    <>
      <section className={styles.cert_info}>
        <h1 className={styles["cert_info--name"]}>
          {certInfoAndStats.cert_info.name}
        </h1>
        <h3 className={styles["cert_info--desc"]}>
          {certInfoAndStats.cert_info.description}
        </h3>
        <h6 className={styles["cert_info--organization"]}>
          주관: {certInfoAndStats.cert_info.host}
        </h6>
      </section>
      <section className={styles.cert_statistic}>
        <div className={styles.representative_stat_container}>
          <article className={styles.representative_stat}>
            ...
            <mark className={styles["representative_stat--value"]}>
              {certInfo.majors}
            </mark>
          </article>
          <article className={styles.representative_stat}>
            ...
            <mark className={styles["representative_stat--value"]}>
              {((certInfo.total_passed / certInfo.total_taken) * 100).toFixed(
                2
              )}
              %
            </mark>
